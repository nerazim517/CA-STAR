from CA_star.FactoryEnvironment import FactoryEnvironment
from CA_star.agent import Agent
...
for i in range(0, 6):
    agents.append(Agent())
agents[0].set_task((0, 0), (19, 19))
agents[1].set_task((19, 19), (0, 0))
agents[2].set_task((19, 0), (0, 19))
agents[3].set_task((0, 19), (19, 0))
agents[4].set_task((18, 0), (1, 0))
agents[5].set_task((0, 18), (0, 0))
